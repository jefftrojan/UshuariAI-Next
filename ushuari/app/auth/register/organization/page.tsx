  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        ...
        toast.info("Your account is pending approval by an administrator");
        ...
        <div className="relative bg-gray-900/60 backdrop-blur-md border border-green-500/20 p-8 rounded-2xl shadow-2xl transition-all duration-300 hover:shadow-green-500/10 hover:shadow-lg">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-4">
              <div>
                <label htmlFor="organization-name" className="block text-sm font-medium text-white/80 mb-1">
                  Organization Name
                </label>
                <input
              ...
              <div>
                <label htmlFor="contact-person" className="block text-sm font-medium text-white/80 mb-1">
                  Contact Person
                </label>
                <input
                  id="contact-person"
