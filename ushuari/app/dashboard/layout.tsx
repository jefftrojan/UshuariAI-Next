...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-black flex relative overflow-hidden">
      ...
      {/* Sidebar */}
      <aside
        className={`bg-gradient-to-b from-purple-900/90 to-purple-950/90 backdrop-blur-sm border-r border-green-900/20 text-white w-64 fixed h-full transition-all duration-300 ${
      ...
      >
        <div className="p-4 border-b border-green-900/20 bg-green-950/50">
          ...
          <p className="text-emerald-100 text-sm">User Dashboard</p>
        </div>
